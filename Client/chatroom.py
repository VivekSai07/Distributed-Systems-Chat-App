...
class Chatroom:
    def __init__(self, vector_clock, network_utils, local_ip, server_inport, server_outport, userName, leader):
    ...
    def chatroom_input(self):
        while True:
            ...
            if message_to_send == "!exit":
                ...
                self.network_utils.send_message(shared_state.server_ip, self.server_inport, "client_id-send_msg-chatroom_id-" + message_to_send + "-" + vc_data + "-" + self.userName)
            ...
            while True:
                ...
                if data:
                    ...
                    if self.vector_clock.vector_clock == self.rcvd_vc and cl_ip == self.local_ip:
                        ...
                        time.sleep(1)
                        self.network_utils.send_message(shared_state.server_ip, self.server_outport, "client_id-recvd-" + str(self.server_inport))
