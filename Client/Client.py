...
class Client:
    ...
    def login(self, userName):
        ...
        shared_state.server_ip, self.server_inport, self.server_outport = self.authentication.login(userName)
        self.vector_clock.init_own_vector()
        self.vector_clock.init_vector_clock()
        self.chatroom = Chatroom(self.vector_clock, self.network_utils, MY_IP, self.server_inport, self.server_outport, self.userName, self.listenToLeader)
